...
text = '''test \n**Код взят у: github.com/Dllhost666**'''
serversName = '.gg/mfjMuwP3Z7'
statusText = '.gg/mfjMuwP3Z7 '

init()

banner = f"""
    ██████{Fore.MAGENTA}╗{Fore.RESET}██{Fore.MAGENTA}╗     {Fore.RESET}██{Fore.MAGENTA}╗{Fore.RESET}     ██{Fore.MAGENTA}╗  {Fore.RESET}██{Fore.MAGENTA}╗{Fore.RESET}
    ██{Fore.MAGENTA}╔══{Fore.RESET}██{Fore.MAGENTA}╗{Fore.RESET}██{Fore.MAGENTA}║     {Fore.RESET}██{Fore.MAGENTA}║{Fore.RESET}     ██{Fore.MAGENTA}║  {Fore.RESET}██{Fore.MAGENTA}║{Fore.RESET}
    ██████{Fore.MAGENTA}╔╝{Fore.RESET}██{Fore.MAGENTA}║     {Fore.RESET}██{Fore.MAGENTA}║{Fore.RESET}     ███████{Fore.MAGENTA}║{Fore.RESET}
    ██{Fore.MAGENTA}╔═══╝ {Fore.RESET}██{Fore.MAGENTA}║     {Fore.RESET}██{Fore.MAGENTA}║{Fore.RESET}     ██{Fore.MAGENTA}╔═{Fore.RESET}██{Fore.MAGENTA}║{Fore.RESET}
    ██{Fore.MAGENTA}║     {Fore.RESET}███████{Fore.MAGENTA}╗{Fore.RESET}███████{Fore.MAGENTA}╗{Fore.RESET}██{Fore.MAGENTA}║ {Fore.RESET}██{Fore.MAGENTA}║{Fore.RESET}
    ╚═╝     ╚══════╝╚══════╝╚═╝  ╚═╝{Fore.MAGENTA}╗{Fore.RESET}

    ██{Fore.MAGENTA}╗{Fore.RESET}██{Fore.MAGENTA}╗  {Fore.RESET}██{Fore.MAGENTA}╗██{Fore.RESET}██████{Fore.MAGENTA}╗{Fore.RESET}██████{Fore.MAGENTA}╗{Fore.RESET}████████{Fore.MAGENTA}╗{Fore.RESET}
    ██{Fore.MAGENTA}║{Fore.RESET}██{Fore.MAGENTA}║  {Fore.RESET}██{Fore.MAGENTA}║██{Fore.RESET}╔════╝{Fore.MAGENTA}██{Fore.RESET}╔══{Fore.MAGENTA}██{Fore.RESET}╗╚══{Fore.RESET}██{Fore.MAGENTA}╔══╝{Fore.RESET}
    ██{Fore.MAGENTA}║{Fore.RESET}███████{Fore.MAGENTA}║{Fore.RESET}██{Fore.MAGENTA}║     {Fore.RESET}██████{Fore.MAGENTA}╔╝{Fore.RESET}   {Fore.MAGENTA}██{Fore.RESET}║{Fore.MAGENTA}   {Fore.RESET}
    ██{Fore.MAGENTA}║{Fore.RESET}██{Fore.MAGENTA}╔══{Fore.RESET}██{Fore.MAGENTA}║{Fore.RESET}██{Fore.MAGENTA}║     {Fore.RESET}██{Fore.MAGENTA}╔═══╝ {Fore.RESET}   {Fore.MAGENTA}██{Fore.RESET}║{Fore.MAGENTA}   {Fore.RESET}
    ██{Fore.MAGENTA}║{Fore.RESET}██{Fore.MAGENTA}║  {Fore.RESET}██{Fore.MAGENTA}║╚{Fore.RESET}██████{Fore.MAGENTA}╗{Fore.RESET}██{Fore.MAGENTA}║     {Fore.RESET}   {Fore.MAGENTA}██{Fore.RESET}║{Fore.MAGENTA}   {Fore.RESET}
    ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝         ╚═╝
...
Телефон: {number if number else "Не привязан"}
...
async def on_ready():
    print(f'''
{Fore.MAGENTA}[ 1 ] Авто нык аккаунта
[ 2 ] Инфо об аккаунте
